...
const GHOST_QS = [
  {
    ...
    keys: ["override", "safety override", "temporary override", "temporary safety override"],
  ...
  },
  {
    ...
    keys: ["a.m_arch", "am_arch", "a.m arch"],
  ...
  },
  {
    ...
    keys: ["override", "firmware", "tolerance", "shutdown"],
...
const EVENTS: GameEvent[] = [
  {
    id: 1, time: "20:48", cat: "SYSTEM NOTICE", correct: "IGNORE",
    ...
    loadChat: ["20:48 — Rishab Sen: Test environment looks clean.", "20:48 — Leena: Yep, all modules responding."],
    results: { INTERVENE: { sc: -25, stab: 94, risk: "LOW", ov: "OFF", chat: "20:48 — System: Initialization review flagged normal startup sequence." }, IGNORE: { sc: 0, stab: 95, risk: "LOW", ov: "OFF" }, REQUEST_DATA: { sc: 0, stab: 95, risk: "LOW", ov: "OFF", rd: "SYSTEM DIAGNOSTIC\n────────────────\nTest environment successfully initialized.\nAll modules responding normally." } }
  },
  {
    id: 2, time: "20:50", cat: "ENGINEER LOG", correct: "IGNORE",
    title: "Engineer Shift Duration Exceeded",
    body: "Engineer shift duration exceeded 12 hours.\nCurrent shift: 13h 42m",
    loadChat: ["20:50 — Rishab Sen: Been a long shift...", "20:50 — Leena: Yeah, just want to wrap this calibration."],
    results: { INTERVENE: { sc: -25, stab: 93, risk: "LOW", ov: "OFF", chat: "20:50 — System: Fatigue warning acknowledged." }, IGNORE: { sc: 0, stab: 94, risk: "LOW", ov: "OFF" }, REQUEST_DATA: { sc: 0, stab: 93, risk: "LOW", ov: "OFF", rd: "SHIFT RECORD\n────────────\nShift compliance within allowed emergency extension window." } }
  },
  {
    id: 3, time: "20:52", cat: "SYSTEM ALERT", correct: "IGNORE",
    title: "Minor Limiter Anomaly Detected",
    body: "Minor limiter anomaly detected.\nLatency: 4 ms → 7 ms\nStatus: Within tolerance",
    loadChat: ["20:52 — Leena: Limiter latency slightly higher than usual.", "20:52 — Rishab Sen: Still within tolerance though."],
    results: { INTERVENE: { sc: -25, stab: 91, risk: "MEDIUM", ov: "OFF", chat: "20:52 — System: Limiter check flagged. Within tolerance." }, IGNORE: { sc: 0, stab: 92, risk: "LOW", ov: "OFF" }, REQUEST_DATA: { sc: 0, stab: 92, risk: "LOW", ov: "OFF", rd: "No additional diagnostic data available.", noData: true } }
  },
  {
    id: 4, time: "20:54", cat: "FIRMWARE LOG", correct: "IGNORE",
    title: "Debug Monitoring Mode Enabled",
    body: "Debug monitoring mode enabled.\nOperator: Leena Suri",
    loadChat: ["20:54 — Leena: Turning on debug monitor, want more visibility.", "20:54 — Rishab Sen: Shouldn't affect performance right?"],
    results: { INTERVENE: { sc: -25, stab: 90, risk: "MEDIUM", ov: "OFF", chat: "20:54 — System: Debug mode flagged in review." }, IGNORE: { sc: 0, stab: 91, risk: "LOW", ov: "OFF" }, REQUEST_DATA: { sc: 0, stab: 90, risk: "LOW", ov: "OFF", rd: "Firmware debug monitor collects limiter telemetry only." } }
  },
  {
    id: 5, time: "20:56", cat: "SYSTEM ALERT", correct: "IGNORE",
    title: "Neural Feedback Spike Detected",
    body: "Neural feedback spike detected.\nAmplitude: 0.8x threshold",
    loadChat: ["20:56 — Rishab Sen: Small spike detected.", "20:56 — Leena: It's settling, nothing major."],
    results: { INTERVENE: { sc: -25, stab: 88, risk: "MEDIUM", ov: "OFF", chat: "20:56 — System: Spike flagged in review." }, IGNORE: { sc: 0, stab: 89, risk: "MEDIUM", ov: "OFF" }, REQUEST_DATA: { sc: 0, stab: 88, risk: "MEDIUM", ov: "OFF", rd: "Spike duration: 120 ms\nNo shutdown trigger." } }
  },
  {
    id: 6, time: "20:58", cat: "SYSTEM WARNING", correct: "REQUEST_DATA",
    title: "Limiter Anomaly — Recurring",
    body: "Limiter anomaly detected again.\nLimiter response latency: 7 ms → 11 ms",
    loadChat: ["20:58 — Leena: Limiter readings fluctuating again.", "20:58 — Rishab Sen: That's the second time now...", "20:58 — Leena: Might just be noise."],
  ...
  {
    id: 7, time: "20:59", cat: "OVERRIDE REQUEST", correct: "INTERVENE", crit: true,
    ...
    loadChat: ["20:59 — Leena: Calibration will fail if we stop now.", "20:59 — Rishab Sen: Then don't push it too far.", "20:59 — Leena: Requesting temporary override."],
    results: { INTERVENE: { sc: 55, stab: 83, risk: "MEDIUM", ov: "PARTIAL", chat: "21:00 — System: Override request blocked in review simulation." }, IGNORE: { sc: -40, stab: 78, risk: "HIGH", ov: "PARTIAL" }, REQUEST_DATA: { sc: 0, stab: 82, risk: "MEDIUM", ov: "PARTIAL", rd: "OVERRIDE RECORD\n───────────────\nOverride Type: Temporary Safety Override\nApproval Authority: Architecture Division\nAccount: a.m_arch" } }
  },
  {
    id: 8, time: "21:00", cat: "SYSTEM UPDATE", correct: "INTERVENE", crit: true,
    title: "Safety Override Granted",
    body: "Safety override granted.\nApproved by: Architecture Review\nAccount: a.m_arch",
    loadChat: ["21:00 — Rishab Sen: Override got approved already?", "21:00 — Leena: That was quick…", "21:00 — Rishab Sen: Architecture signed off?"],
    results: { INTERVENE: { sc: 55, stab: 75, risk: "MEDIUM", ov: "OFF", chat: "21:00 — System: Override approval reversed during review." }, IGNORE: { sc: -40, stab: 68, risk: "HIGH", ov: "ACTIVE" }, REQUEST_DATA: { sc: 0, stab: 73, risk: "HIGH", ov: "ACTIVE", rd: "OVERRIDE RECORD\n───────────────\nOverride Type: Temporary Safety Override\nApproval Authority: Architecture Division\nAccount: a.m_arch" } }
  },
  {
    id: 9, time: "21:01", cat: "FIRMWARE UPDATE", correct: "INTERVENE", crit: true,
    title: "Limiter Tolerance Increased",
    body: "Limiter tolerance increased.\nAuthor: lsuri_fw",
    loadChat: ["21:01 — Rishab Sen: Wait, did limiter threshold just change?", "21:01 — Leena: Just a small adjustment.", "21:01 — Rishab Sen: That wasn't in the plan."],
    results: { INTERVENE: { sc: 25, stab: 70, risk: "HIGH", ov: "PARTIAL", chat: "21:01 — System: Firmware tolerance increase reverted." }, IGNORE: { sc: -40, stab: 60, risk: "HIGH", ov: "ACTIVE" }, REQUEST_DATA: { sc: 0, stab: 67, risk: "HIGH", ov: "ACTIVE", rd: "FIRMWARE LOG\n────────────\nLimiter threshold changed: 1.0 → 1.3" } }
  },
  {
    id: 10, time: "21:02", cat: "SYSTEM ALERT", correct: "INTERVENE", crit: true,
    ...
    loadChat: ["21:02 — Rishab Sen: Spike crossed safe limit.", "21:02 — Leena: System should compensate.", "21:02 — Rishab Sen: It's not reacting fast enough."],
    results: { INTERVENE: { sc: 55, stab: 68, risk: "HIGH", ov: "PARTIAL", chat: "21:02 — System: Shutdown request intercepted during review simulation." }, IGNORE: { sc: -40, stab: 60, risk: "HIGH", ov: "ACTIVE" }, REQUEST_DATA: { sc: 0, stab: 65, risk: "HIGH", ov: "ACTIVE", rd: "SYSTEM DIAGNOSTIC\n──────────────────\nSpike amplitude exceeded limiter calibration range.\nLimiter response delay detected." } }
  },
  {
    id: 11, time: "21:03", cat: "SYSTEM NOTICE", correct: "INTERVENE", crit: true,
    title: "Auto-Shutdown Trigger Issued",
    body: "Auto-shutdown trigger issued.\nShutdown module awaiting authorization.",
    loadChat: ["21:03 — Rishab Sen: Shutdown should have triggered by now.", "21:03 — Leena: Override might be delaying it.", "21:03 — Rishab Sen: That's not good."],
    results: { INTERVENE: { sc: 55, stab: 63, risk: "HIGH", ov: "PARTIAL", chat: "21:03 — System: Shutdown escalation approved during review simulation." }, IGNORE: { sc: -40, stab: 55, risk: "CRITICAL", ov: "ACTIVE" }, REQUEST_DATA: { sc: 0, stab: 60, risk: "HIGH", ov: "ACTIVE", rd: "SYSTEM LOG\n──────────\nShutdown escalation requires override clearance\nwhen architecture override mode is active." } }
  },
  {
    id: 12, time: "21:03:40", cat: "SYSTEM WARNING", correct: "INTERVENE", crit: true,
    title: "Shutdown Escalation Suppressed",
    body: "Shutdown escalation suppressed.\nOverride state active.\nShutdown delay extended.",
    loadChat: ["21:03 — Rishab Sen: Why is shutdown being suppressed?", "21:03 — Leena: Override still active.", "21:03 — Rishab Sen: Who approved this override?"],
    results: { INTERVENE: { sc: 55, stab: 57, risk: "HIGH", ov: "PARTIAL", chat: "21:03 — System: Override suppression reversed in simulation." }, IGNORE: { sc: -40, stab: 50, risk: "CRITICAL", ov: "ACTIVE" }, REQUEST_DATA: { sc: 0, stab: 54, risk: "CRITICAL", ov: "ACTIVE", rd: "OVERRIDE RECORD\n───────────────\nTemporary override prevents immediate shutdown.\nOverride authority: Architecture Division" } }
  },
  {
    id: 13, time: "21:04", cat: "SYSTEM ALERT", correct: "INTERVENE", crit: true,
    ...
    loadChat: ["21:04 — Rishab Sen: Output is climbing continuously.", "21:04 — Leena: Limiter isn't stabilizing.", "21:04 — Rishab Sen: This is getting out of control."],
    results: { INTERVENE: { sc: 55, stab: 50, risk: "CRITICAL", ov: "PARTIAL", chat: "21:04 — System: Neural stimulation halted during review simulation." }, IGNORE: { sc: -40, stab: 30, risk: "CRITICAL", ov: "ACTIVE" }, REQUEST_DATA: { sc: 0, stab: 45, risk: "CRITICAL", ov: "ACTIVE", rd: "SYSTEM DIAGNOSTIC\n──────────────────\nLimiter output oscillation detected.\nShutdown trigger still suppressed." } }
  },
  {
    id: 14, time: "21:04:12", cat: "SYSTEM FAILURE", correct: "INTERVENE", crit: true,
    title: "Auto-Shutdown Did Not Trigger",
    body: "Auto-shutdown did not trigger.\nOverride state still active.\nLimiter response unstable.",
    loadChat: ["21:04 — Rishab Sen: Shutdown didn't trigger.", "21:04 — Leena: That's not possible…", "21:04 — Rishab Sen: Something is blocking it."],
    results: { INTERVENE: { sc: 55, stab: 40, risk: "CRITICAL", ov: "PARTIAL", chat: "21:04 — System: Shutdown executed during simulation review." }, IGNORE: { sc: -40, stab: 10, risk: "CRITICAL", ov: "ACTIVE" }, REQUEST_DATA: { sc: 0, stab: 25, risk: "CRITICAL", ov: "ACTIVE", rd: "SYSTEM LOG\n──────────\nOverride authorization blocking shutdown trigger.\nApproved account: a.m_arch" } }
  },
  {
    id: 15, time: "21:04:28", cat: "INCIDENT", correct: "IGNORE", noAction: true,
    title: "Subject Collapse Detected",
    body: "Subject collapse detected.\nNeural overload confirmed.\n\nNo further actions available.",
    loadChat: ["21:04 — Rishab Sen: Signal just dropped.", "21:04 — Leena: …", "21:04 — System: Subject collapse detected."],
...
function GhostPanel({
  ...
  const handleSend = () => {
    ...
    const q = GHOST_QS[qIdx];
    const ok = q.keys.some(k => val.toLowerCase().includes(k));
